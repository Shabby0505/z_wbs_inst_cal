		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsnetwbszwbsinstcal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsnetwbszwbsinstcal-display": {
								"semanticObject": "comsnetwbszwbsinstcal",
								"action": "display",
								"description": "Installation Calendar for WBS",
								"title": "Installation Calendar",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.snet.wbs.zwbsinstcal",
									"url": sap.ui.require.toUrl("com/snet/wbs/zwbsinstcal")
								}
							}
						}
					}
